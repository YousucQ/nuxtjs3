...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/devalue/index.js';
import destr from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lukdfcLltv = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/YousakuQuroiwa/nuxtjs3/hello-nuxt";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _tLSEiuxy00 = (nitroApp) => {
...
const _lazy_dxZNx3 = () => Promise.resolve().then(function () { return members_post$1; });
const _lazy_6EJvOu = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_Ccb2mn = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/member-management/members', handler: _lazy_dxZNx3, lazy: true, middleware: false, method: "post" },
  { route: '/member-management/members/:id', handler: _lazy_6EJvOu, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_Ccb2mn, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Ccb2mn, lazy: true, middleware: false, method: undefined }
];
...
const addMemberInfo = defineEventHandler(async (event) => {
...
const addMemberInfo$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const getMemberList = defineEventHandler((event) => {
...
const getMemberList$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getMemberList
});

const getOneMemberInfo = defineEventHandler((event) => {
...
const getOneMemberInfo$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const members_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const getClientManifest = () => import('file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/YousakuQuroiwa/nuxtjs3/hello-nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
